...
*/
carro.mudarCor = function(corDoCarro) {
...
carro.obterMarcaModelo() // 'Esse carro é um Fiat Mobi'

// Adicione 2 pessoas no carro.

carro.adicionarPessoas(2); // ja temos 2 pessoas no carro

// Adicione mais 4 pessoas no carro.

carro.adicionarPessoas(4) // O carro ja está lotado
