...
console.log( text.replace( /Manuel Marques de Sousa/g, 'Abhener Bruno Calson da Silva' ) );
...
console.log( text.replace( /brasileiro/g, 'Dois-Irmãosense'  ) );
...
console.log( `O mês de março é representado pelo ${getMonthNumber('março')}.` );
console.log( `O mês de setembro é representado pelo ${getMonthNumber('setembro')}.` );
console.log( `O mês de dezembro é representado pelo ${getMonthNumber('dezembro')}.` );
