...
pessoa.nomeCompleto(); // Olá! Meu nome é Abhener Calson
...
pessoa.apresentacao = function() {
    ...
    return `Olá! Eu sou ${sexo} ${pessoa.nome} ${pessoa.sobrenome}, tenho ${pessoa.idade} ${idadeAnos}, ${pessoa.mostrarAltura()} Meu peso é ${pessoa.peso}Kg e, só hoje, eu ja caminhei ${pessoa.caminhouQuantosMetros} ${metrosCaminhados}!`
};
